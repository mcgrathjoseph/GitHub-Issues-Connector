...
// joehmm: If you need additional logic to get all items from the repository, you can add it here. This function is used to get all items from the repository, filtered to exclude pull requests and only include issues
